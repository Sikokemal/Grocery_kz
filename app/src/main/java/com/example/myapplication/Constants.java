...
public class    Constants {
   ...
   */
  public static final String COUNTRY_CODE = "KZ";
   ...
   */
  public static final String CURRENCY_CODE = "KZT";
   ...
   */
  public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("US", "GB","KZ");
   ...
   */
  public static final String PAYMENT_GATEWAY_TOKENIZATION_NAME = "SSS";
