...
public class ProductAdapterall extends RecyclerView.Adapter<ProductAdapterall.ViewHolder> {
    ...
    public ProductAdapterall(Context context, List<Product> products) {
